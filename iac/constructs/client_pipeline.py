    ...
    def __init__(
        ...
        **kwargs,
        ...
        build_action = codepipeline_actions.CodeBuildAction(
            ...
            project=codebuild.PipelineProject(
                ...
                environment=codebuild.BuildEnvironment(
                    build_image=codebuild.LinuxBuildImage.STANDARD_6_0, privileged=True
                ),
            ),
            input=source_output,
        ...
        deploy_action = codepipeline_actions.S3DeployAction(
            action_name="Deploy", input=build_output, bucket=client_bucket
        )
        ...
        invalidate_build_project.add_to_role_policy(
            iam.PolicyStatement(
                resources=[distribution_arn], actions=["cloudfront:CreateInvalidation"]
            )
        )
        ...
        codepipeline.Pipeline(
            ...
            stages=[
                ...
                codepipeline.StageProps(
                    stage_name="Deploy", actions=[deploy_action, invalidate_action]
                ),
            ],
        )
